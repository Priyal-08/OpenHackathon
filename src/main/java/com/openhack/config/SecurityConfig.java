...
import com.openhack.security.CustomUserDetailsService;
import com.openhack.security.JwtAuthenticationEntryPoint;
import com.openhack.security.JwtAuthenticationFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/hackathon/{\\d+}/earningreport/**").hasAuthority("Admin")
                    .antMatchers(HttpMethod.POST, "/hackathon/{\\d+}/expense").hasAuthority("Admin")
